...
export default function Dashboard() {
  ...
  return <div className="site-root">
    ...
    {announcement ? <div className="announcement"><span>Introducing MetaTray. A cortical market experiment.</span><Link href="/science">Explore the science <ArrowRight size={14}/></Link><button className="announcement-close" aria-label="Dismiss announcement" onClick={() => setAnnouncement(false)}><X size={16}/></button></div> : null}
    ...
    <main id="main-content">
        <section className="hero">
          <div className="hero-copy">
            ...
            <div className="hero-note">Real market input. Separately verified model output. Paper only.</div><div className="hero-source-links"><Link href="/lore">Enter the lore</Link><a href={METATRAY_REPOSITORY} target="_blank" rel="noreferrer">MetaTray on GitHub <ArrowUpRight size={13}/></a><a href={META_REPOSITORY} target="_blank" rel="noreferrer">Meta TRIBE v2 <ArrowUpRight size={13}/></a><Link href="/evidence">Code & evidence</Link></div>
      ...
      <section className="explore-pages" aria-label="Learn about MetaTray"><div><span className="section-kicker">[ Inside MetaTray ]</span><h2>Understand the experiment.</h2></div><div className="explore-grid">{[
        ['/about', '01', 'About MetaTray', 'The idea, the experience, and the boundaries.'],
        ...
        ['/lore', '04', 'The lore', 'The Silence, the Pulse, the Cortical Echo, and the Chronicle.']
